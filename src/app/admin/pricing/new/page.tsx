...
export default function NewPricingPlan() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(err instanceof Error ? err.message : 'Failed to create pricing plan')
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold mb-2">Create New Pricing Plan</h1>
          <p className="text-muted-foreground">
            Add a new pricing option for your customers.
          </p>
        </div>
      </div>
